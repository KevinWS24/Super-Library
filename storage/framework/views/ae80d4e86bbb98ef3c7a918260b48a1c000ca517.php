 <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/buku" class="nav-link  <?php echo $__env->yieldContent('active-buku'); ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buku</p>
                </a>
              </li>
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH C:\Users\User\UAS\laravel8_perpustakaan-master\resources\views/admin-lte/sidebar.blade.php ENDPATH**/ ?>